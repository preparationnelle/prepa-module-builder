...
// Si tu as déjà un LatexViewer :
import { LatexViewer } from "@/components/LatexViewer" 

const CHAPITRE_4_LATEX = String.raw`
...
\section*{Valeurs trigonométriques remarquables}
\[
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="prose max-w-none text-lg">
          {/* Si LatexViewer fonctionne */}
          <LatexViewer tex={CHAPITRE_4_LATEX} />

          {/* Si pas de LatexViewer encore, tu peux afficher comme ça temporairement :
