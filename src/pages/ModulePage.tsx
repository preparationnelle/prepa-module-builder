...
const ModulePage = () => {
  ...
  const moduleData = {
    "0": {
      ...
      subtitle: "Module 0",
      objectives: ["Comprendre pourquoi Python rapporte facilement des points au concours ECG.", "Maîtriser les bases du langage et les principales librairies utiles.", "Savoir écrire et structurer un script ou une fonction simple.", "Manipuler les listes et utiliser les boucles/conditions efficacement.", "Être capable de traiter tous les types d'exercices classiques en Python au concours."],
      notions: [{
  ...
  return <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <FormationButton variant="outline" onClick={() => navigate("/formation/maths")} className="mb-6">
        ...
        <Card className="border border-formation-orange/20 mb-8">
          <CardContent className="p-6">
            ...
            <ul className="space-y-3">
              {currentModule.objectives.map((objective, index) => <li key={index} className="flex items-start gap-3">
        ...
        <div className="space-y-4">
          {currentModule.notions.map((notion, index) => <Card key={index} className="border border-formation-orange/20">
              <CardContent className="p-6">
